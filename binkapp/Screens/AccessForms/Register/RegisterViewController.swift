...
class RegisterViewController: BaseFormViewController {
    ...
    @objc func continueButtonTapped() {
        ...
        Current.apiClient.performRequestWithBody(request, body: loginRequest, expecting: LoginRegisterResponse.self) { [weak self] result in
            switch result {
    ...
    func updatePreferences(checkboxes: [CheckboxView]) {
        ...
        Current.apiClient.performRequestWithNoResponse(request, body: nil, completion: nil)
    }
