        ...
        case .failed, .unauthorised:
            ...
            if let reasonCode = membershipCard.status?.formattedReasonCodes?.first {
                ...
                case .accountAlreadyExists:
                    ...
                    break
                case .accountDoesNotExist, .addDataRejectedByMerchant, .noAuthorizationProvided, .noAuthorizationRequired, .authorizationDataRejectedByMerchant, .authorizationExpired, .pointsScrapingLoginFailed:
                    // Points module 1.6
