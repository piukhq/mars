    ...
    enum RowType {
        ...
        func handleSelection(_ selection: String) {
            ...
            case .snackbar:
                ...
                case .multiline:
                    InfoAlertView.show("This is a snackbar with so much text, the label is like whuuuut?! I can't contain this much text yo, I'm gonna spill", type: .snackbar(.short))
                case .action:
