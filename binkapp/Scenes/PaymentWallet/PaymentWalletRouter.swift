...
class PaymentWalletRouter: NSObject, PaymentWalletRoutingLogic, PaymentWalletDataPassing
{
  ...
  //func navigateToSomewhere(source: PaymentWalletViewController, destination: SomewhereViewController)
  //{
  ...
  //func passDataToSomewhere(source: PaymentWalletDataStore, destination: inout SomewhereDataStore)
  //{
