...
class Wallet: NSObject, CoreDataRepositoryProtocol, WalletServiceProtocol {
    ...
    private func customCardPlan() -> MembershipPlanModel {
        ...
        let cardNumberField = AddFieldModel(apiId: 0, column: L10n.customCardNumberAddFieldTitle, validation: nil, fieldDescription: L10n.customCardNumberAddFieldDescription, type: 0, choices: nil, commonName: nil, alternatives: nil)
