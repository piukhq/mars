...
class PaymentCardDetailLoyaltyCardStatusCellViewModelTests: XCTestCase, CoreDataTestable {
    ...
    override class func setUp() {
        ...
        baseMembershipCardResponse = MembershipCardModel(apiId: 300, membershipPlan: 500, membershipTransactions: nil, status: membershipCardStatusModel, card: nil, images: nil, account: nil, paymentCards: nil, balances: nil, vouchers: nil)
