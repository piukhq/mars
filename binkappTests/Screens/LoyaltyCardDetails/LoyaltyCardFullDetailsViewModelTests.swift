...
class LoyaltyCardFullDetailsViewModelTests: XCTestCase, CoreDataTestable {
    ...
    override class func setUp() {
        ...
        baseMembershipCardResponse = MembershipCardModel(apiId: 300, membershipPlan: 500, membershipTransactions: nil, status: membershipCardStatusModel, card: cardModel, images: nil, account: nil, paymentCards: nil, balances: [membershipCardBalanceModel], vouchers: [voucherResponse], openedTime: Date())
