...
class PLRRewardDetailViewModelTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        voucher = VoucherModel(apiId: nil, state: nil, code: nil, barcode: nil, barcodeType: nil, headline: nil, subtext: nil, dateRedeemed: nil, dateIssued: nil, expiryDate: nil, earn: nil, burn: nil)
    }
