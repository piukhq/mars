...
url = 'https://mobsf.tools.uksouth.bink.sh/api/v1/upload'
...
url = 'https://mobsf.tools.uksouth.bink.sh/api/v1/scan'
...
url = 'https://mobsf.tools.uksouth.bink.sh/api/v1/download_pdf'
